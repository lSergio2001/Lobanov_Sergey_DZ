/*Ќапишите программу дл€ работы с датами согласно григорианскому
календарю. ¬ программе должны присутствовать: структура хран€ща€
год, мес€ц, число и умеюща€(с помощью соответствующего метода)
определ€ть по дате день недели. 3 функции определ€ющие сколько
лет, мес€цев и дней прошло между двум€ датами */
